#!/bin/bash
### Install a new chrooted P2P server
### from scratch, with debootstrap.

function usage {
    echo "
Usage: $0 [OPTIONS] <target>
Install P2P inside a chroot in the target directory.
...
chroot $target_dir /tmp/install/install-chroot.sh
